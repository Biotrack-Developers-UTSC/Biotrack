...
<body>
    <div class="welcome-card p-6 md:p-10">
        <h1 class="text-4xl font-extrabold text-gray-800 mb-2 text-center"> ¡Bienvenido, {{ $user->name }}! </h1>
        <p
            class="text-xl font-medium mb-10 pb-4 border-b border-gray-200 text-center @if($user->role === 'admin') text-red-600 @elseif($user->role === 'guardaparque') text-green-600 @else text-gray-600 @endif">
            Tu Rol: <span class="uppercase font-extrabold">{{ $user->role }}</span> </p>
        ...
        $isUser = $user->role === 'user'; @endphp
        <div
            class="card-container @if($isAdmin) triple @elseif($isGuardaparque) double @else single @endif {{ $isUser || $isGuardaparque ? 'mx-auto text-center' : '' }}">
            {{-- ADMIN --}} @if($isAdmin)
                <div class="action-card bg-admin">
                    ...
                    <div class="space-y-2 mt-4"> <a href="{{ route('admin.iot') }}"
                            ...
                            <i class="fas fa-microchip mr-1"></i> Configuración IoT </a> <a
                            ...
                            <i class="fas fa-users-cog mr-1"></i> Gestión de Usuarios </a> <a
                            ...
                            <i class="fas fa-cogs mr-1"></i> Configuración </a> </div>
                </div>
                <div class="action-card bg-guardaparque">
                    ...
                    <div class="space-y-2 mt-4"> <a href="{{ route('guardaparques.dashboard') }}"
                            ...
                            <i class="fas fa-binoculars mr-1"></i> Dashboard </a> <a href="{{ route('animales.index') }}"
                            ...
                            <i class="fas fa-edit mr-1"></i> CRUD de Especies </a> </div>
                </div>
                <div class="action-card bg-user">
                    ...
                    <div class="space-y-2 mt-4"> <a href="{{ route('consultas.index') }}"
                            ...
                            <i class="fas fa-search mr-1"></i> Consultas </a> <a href="{{ route('qr.scanner.ui') }}"
                            ...
                            <i class="fas fa-qrcode mr-1"></i> Escanear QR </a> <a href="{{ route('juegos.futbol') }}"
                            ...
                            <i class="fas fa-gamepad mr-1"></i> Jugar Fútbol </a> </div>
            </div> @endif {{-- GUARDAPARQUE --}} @if($isGuardaparque)
                <div class="action-card bg-guardaparque guardaparque-card">
                    ...
                    <div class="space-y-4 mt-4"> <a href="{{ route('guardaparques.dashboard') }}"
                            class="block text-center btn-big bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg transition-colors">
                            <i class="fas fa-tachometer-alt mr-1"></i> Dashboard de Alarmas </a> <a
                ...
                <div class="action-card bg-user guardaparque-card">
                    ...
                    <div class="space-y-4 mt-4"> <a href="{{ route('consultas.index') }}"
        ...
        <div class="mt-12 text-center border-t pt-6">
            <form method="POST" action="{{ route('logout') }}"> @csrf <button type="submit"
                    ...
                    Cerrar Sesión <i class="fas fa-sign-out-alt ml-2"></i> </button> </form>
        </div>
    </div>
</body>
